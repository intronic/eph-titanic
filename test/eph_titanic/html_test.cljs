...
(deftest table-test
  (testing "cell ids"
    ...
    (is (= 0 (h/id->num (h/row-id 0))))
    (is (= 100 (h/id->num (h/row-id 100))))
    (is (= 0 (h/id->num (h/cell-id 0))))
    (is (= 100 (h/id->num (h/cell-id 100))))
    (is (= [0 0] (h/cell-coords 3 0)))
    (is (= [0 1] (h/cell-coords 3 1)))
    (is (= [0 2] (h/cell-coords 3 2)))
    (is (= [1 0] (h/cell-coords 3 3)))
