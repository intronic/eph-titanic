(defproject eph-titanic "0.1.0-SNAPSHOT"
  :description "Programming Exercise: Shuffling the table cells on the titanic."
  :url "http://github.com/intronic/eph-titanic"
